...
{
  return FileClassPrefix(file) + full_name;
}
...
string ClassNameWorker(const Descriptor *descriptor)
{
  ...
  if(descriptor->containing_type() != NULL) {
    name = ClassNameWorker(descriptor->containing_type()) + "_";
  }
...
{
  return FileClassPrefix(descriptor->file()) + ClassNameWorker(descriptor);
}
...
{
  return FileClassPrefix(descriptor->file()) + descriptor->name();
}


string EnumValueName(const EnumValueDescriptor *descriptor)
{
  return ClassName(descriptor->type()) + UnderscoresToCapitalizedCamelCase(SafeName(descriptor->name()));
}
...
string DefaultValue(const FieldDescriptor *field)
{
  ...
  switch(field->cpp_type()) {
    ...
    case FieldDescriptor::CPPTYPE_STRING:
      if(field->type() == FieldDescriptor::TYPE_BYTES) {
        if(field->has_default_value()) {
          return
            "[NSData dataWithBytes:\"" + CEscape(field->default_value_string()) + "\" " +
            "length:" + SimpleItoa(field->default_value_string().length()) + "]";
        } else {
          return "nil";//"[NSData data]";
        }
      } else {
        if(field->has_default_value()) {
          if(AllAscii(field->default_value_string())) {
            ...
            return "[NSString stringWithUTF8String:\"" + EscapeTrigraphs(CEscape(field->default_value_string())) + "\"]";
          }
        } else {
          return "nil";
        }
    ...
    case FieldDescriptor::CPPTYPE_MESSAGE:
      return "nil";//"[" + ClassName(field->message_type()) + " defaultInstance]";
  }
...
const char *GetArrayValueType(const FieldDescriptor *field)
{
  switch(field->type()) {
    case FieldDescriptor::TYPE_INT32:
      return "PBArrayValueTypeInt32";
    case FieldDescriptor::TYPE_UINT32:
      return "PBArrayValueTypeUInt32";
    case FieldDescriptor::TYPE_SINT32:
      return "PBArrayValueTypeInt32";
    case FieldDescriptor::TYPE_FIXED32:
      return "PBArrayValueTypeUInt32";
    case FieldDescriptor::TYPE_SFIXED32:
      return "PBArrayValueTypeInt32";
    case FieldDescriptor::TYPE_INT64:
      return "PBArrayValueTypeInt64";
    case FieldDescriptor::TYPE_UINT64:
      return "PBArrayValueTypeUInt64";
    case FieldDescriptor::TYPE_SINT64:
      return "PBArrayValueTypeInt64";
    case FieldDescriptor::TYPE_FIXED64:
      return "PBArrayValueTypeUInt64";
    case FieldDescriptor::TYPE_SFIXED64:
      return "PBArrayValueTypeInt64";
    case FieldDescriptor::TYPE_FLOAT:
      return "PBArrayValueTypeFloat";
    case FieldDescriptor::TYPE_DOUBLE:
      return "PBArrayValueTypeDouble";
    case FieldDescriptor::TYPE_BOOL:
      return "PBArrayValueTypeBool";
