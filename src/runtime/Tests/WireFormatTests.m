...
- (void)testParseExtensions
{
  ...
  TestAllExtensions *message2 = [TestAllExtensions parseFromData:rawBytes extensionRegistry:registry];
...
- (void)testParsePackedExtensions
{
  ...
  TestPackedExtensions *message2 = [TestPackedExtensions parseFromData:rawBytes extensionRegistry:registry];
