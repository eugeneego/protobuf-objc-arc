...
@property (nonatomic) int32_t foo2;
- (void)clearFoo2;
- (BOOL)hasFoo2;

@property (nonatomic) int32_t foo3;
- (void)clearFoo3;
- (BOOL)hasFoo3;
...
@property (nonatomic, strong) ComplexOptionType1 *bar;
- (void)clearBar;
- (BOOL)hasBar;

@property (nonatomic) int32_t baz;
- (void)clearBaz;
- (BOOL)hasBaz;

@property (nonatomic, strong) ComplexOptionType2_ComplexOptionType4 *fred;
- (void)clearFred;
- (BOOL)hasFred;
...
@property (nonatomic) int32_t waldo;
- (void)clearWaldo;
- (BOOL)hasWaldo;
...
@property (nonatomic) int32_t qux;
- (void)clearQux;
- (BOOL)hasQux;

@property (nonatomic, strong) ComplexOptionType3_ComplexOptionType5 *complexOptionType5;
...
@property (nonatomic) int32_t plugh;
- (void)clearPlugh;
- (BOOL)hasPlugh;
...
@property (nonatomic) int32_t xyzzy;
- (void)clearXyzzy;
- (BOOL)hasXyzzy;
...
@property (nonatomic, strong) Aggregate *sub;
- (void)clearSub;
- (BOOL)hasSub;

@property (nonatomic, strong) PBFileOptions *file;
- (void)clearFile;
- (BOOL)hasFile;

@property (nonatomic, strong) AggregateMessageSet *mset;
- (void)clearMset;
- (BOOL)hasMset;
...
@property (nonatomic) int32_t fieldname;
- (void)clearFieldname;
- (BOOL)hasFieldname;
